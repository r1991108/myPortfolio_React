          ...
          <div className="col-md-4 o-3column ">
            <div className="h-100 p-3  rounded-3 section">
              ...
              <p>
                ...
                日本語を勉強しつつ、将来のことを考えていた時に、たまたまプログラミングに接触してその魅力を強く感じた私は独学で知識を獲得し、IT業界に入ってきました。
                <br />
                今までは証券や保険会社の情報システム部門で保守、開発案件に携わっていました。AWS資格を獲得した後、ある銀行のクラウド基盤部門でAWS移行プロジェクトに参画していました。
                <br />
                現在は自社開発の会社でAWSを用いてIaCやCI/CDを実践し、安全かつ迅速、継続的な開発ワークフローに取り組んでおります。
                <br />
                趣味は、Udemyのオンラインコースやネットサイトで知識を獲得することです。現在持っているAWS資格は
                SAA、SAPです。
                <br />
